...
| `priceGuide` | Normalized price-guide rows for this product. | `[{"condition": "", "printing": "", "lowPrice": 0.1, "marketPrice": null, "medianPrice":...` |
...
| Field | Meaning | Example |
| --- | --- | --- |
| `condition` | Observed field in the generated JSON. | `` |
| `lowPrice` | Observed field in the generated JSON. | `0.1` |
| `marketPrice` | Observed field in the generated JSON. |  |
| `medianPrice` | Observed field in the generated JSON. | `0.33` |
| `printing` | Observed field in the generated JSON. | `` |
