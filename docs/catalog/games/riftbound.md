...
| `customAttributes.flavorText` | string | 45 / 1199 | 3.75% | `<em>"Challenge Shurima, challenge fate."</em>` |
| `flavorText` | string | 45 / 1199 | 3.75% | `<em>"Challenge Shurima, challenge fate."</em>` |
